...
class CTkRadarChart(tk.Canvas, CTkAppearanceModeBaseClass, CTkScalingBaseClass):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.fg_color = (
            customtkinter.ThemeManager.theme["CTkButton"]["border_color"] if fg_color is None else text_color
        )
        self.text_color = (
            customtkinter.ThemeManager.theme["CTkLabel"]["text_color"] if text_color is None else text_color
        )
    ...
    def draw_background(self):
        ...
        for i in range(self.num_axes):
            ...
            self.create_line(
                self.center[0], self.center[1], x, y, fill=self.master._apply_appearance_mode(self.fg_color)
            )
